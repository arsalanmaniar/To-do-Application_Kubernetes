...
export default function ChatPage() {
  ...
  const [isChatOpen, setIsChatOpen] = useState(true); // Always open in chat page
          ...
          <main className="flex-1 py-8">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-8">
                ...
                <p className="mt-2 text-gray-600">Chat with our AI assistant to get help with your tasks</p>
              </div>
